        ...
        this.sliderTutorial = [
            {
                ...
                usages: 'Presenters should use this view to Present in Sabha',
            },
            {
                key: 'Singer View',
                usages:
                    'Kirtan Team should use this view (Landscape) when singing',
            },
            {
                key: 'Sidebar',
                usages: 'Navigate between creating a DPK or viewing Slides',
            },
            {
                key: 'DPK Creation',
                usages:
                    'To create a DPK, please login then head over to the creation page for detailed instructions',
            },
            {
                key: 'Next Steps',
                usages: 'View a current DPK or create a new DPK one',
            },
        ]
    }
}
